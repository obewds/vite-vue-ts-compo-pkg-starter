import{_ as n,c as s,o as a,a as t}from"./app.7dcff95f.js";const d='{"title":"ViteVueTsCompoPkgStarter.vue Tests","description":"","frontmatter":{"head":[["link",{"rel":"icon","href":"favicon.ico"}]]},"headers":[{"level":2,"title":"Current Testing Status","slug":"current-testing-status"},{"level":2,"title":"Vitest Tests","slug":"vitest-tests"}],"relativePath":"tests.md"}',p={},e=t(`<h1 id="vitevuetscompopkgstarter-vue-tests" tabindex="-1">ViteVueTsCompoPkgStarter.vue Tests <a class="header-anchor" href="#vitevuetscompopkgstarter-vue-tests" aria-hidden="true">#</a></h1><h2 id="current-testing-status" tabindex="-1">Current Testing Status <a class="header-anchor" href="#current-testing-status" aria-hidden="true">#</a></h2><div class="tip custom-block"><p class="custom-block-title">CURRENT COVERAGE</p><p><strong>100%</strong></p></div><h2 id="vitest-tests" tabindex="-1">Vitest Tests <a class="header-anchor" href="#vitest-tests" aria-hidden="true">#</a></h2><div class="language-js line-numbers-mode"><pre><code><span class="token comment">// ./tests/ViteVueTsCompoPkgStarter.test.js</span>
...
<span class="token keyword">import</span> ViteVueTsCompoPkgStarter <span class="token keyword">from</span> <span class="token string">&#39;../src/ViteVueTsCompoPkgStarter.vue&#39;</span>
